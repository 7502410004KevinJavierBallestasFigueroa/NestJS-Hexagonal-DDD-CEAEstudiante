...
const exceptions_2 = require("../../../domain/estudiantes/exceptions");
let DomainExceptionFilter = class DomainExceptionFilter {
        ...
        const map = new Map([
            ...
            [exceptions_2.EstudianteNotFoundException, { status: common_1.HttpStatus.NOT_FOUND, message: exception.message }],
            [exceptions_2.EmailEstudianteDuplicadoException, { status: common_1.HttpStatus.CONFLICT, message: exception.message }],
        ]);
